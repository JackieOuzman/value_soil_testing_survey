...
* For the growers we have some very low responses rates eg lower EP
  this grouping cannot be used as is an will need to be merged results are to reflect regional differences.
...
* Can't combine the data for this - perhaps indicates a pattern for the whole study (combine the two groups with causion)
* Belinda Cay has added a grouping for this question, her farms size grouping is:
...
* question was asked as percent of percent - convert to a table?
