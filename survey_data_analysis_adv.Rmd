...
#filter(Q3_regions_agro_grower_narrow, Resp_Group == "Grower" ) %>% 
  ...
  ggplot(Q3_regions_agro_grower_narrow, aes(crop, ave_area))+
  geom_col()+
  #geom_text(aes(label = Ave_Cropped_Area), vjust = -1.0, hjust = 0.5)+
  facet_wrap(.~ Resp_Group)+
  theme_classic()+
  ...
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8)) +
        scale_y_continuous("percentage", breaks=seq(0, 100, 20), labels=c("0%", "20%", "40%", "60%", "80%", "100%"))
