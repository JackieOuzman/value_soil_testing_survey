...
Q1_resp_percent <- data %>% 
  ...
  mutate(percent = 
           (freq = n / sum(n)))
#table
datatable(Q1_resp_percent, colnames = c('Respondant' = 'Resp_Group')) %>%
...
#head(Q2_agro_grower)
datatable(Q2_agro_grower, colnames = c( "Respondants", "count", "Average cropped area"))
...
datatable(Q4_resp_percent, colnames = c('Respondant' = 'Resp_Group')) %>%
  formatPercentage('percent', 0) 
...
ggplot(Q4_resp_percent, aes(Q_4, percent, fill =Resp_Group ))+
  ...
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
        scale_y_continuous("Respondant", breaks=seq(0, 1.0, 0.1)
