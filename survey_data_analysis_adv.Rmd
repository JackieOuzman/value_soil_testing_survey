...
```{r Q3 working, include=FALSE, regions agro only, echo=FALSE}
...
* If the cropped area is wrong for question 2, cropped area by crop will be wrong too! I have removed the agronmist data.
...
```{r Q4 regions working, echo=FALSE, warning=FALSE}
...
filter(Q4group_resp__rainfall_percent, Resp_Group == 	"Agronomist" ) %>% 
datatable(Q4_resp_percent, 
          options = list(
        lengthMenu = list(c(1, 13, -1), c('1', '13', 'All')),
        pageLength = 13))
#,
