...
```{r Q4 gregions, echo=FALSE, warning=FALSE}
...
datatable((Q4group_resp__rainfall_percent), options = list(pageLength = 24))
...
datatable(otherQ9.2, colnames = c( "other reasons" = "Q_9.2"), options = list(pageLength = 11))
...
```{r Q10.1 graph - how much testing, echo=FALSE, message=FALSE, warning=TRUE}
...
This question can be a bit confusing each respondent was asked: to what extent do test results influence recommendations, the respondents were asked to nominate a certain percentage category e.g. between 10-30% of test results influence the recommendation this is what is displayed on the x axis.
...
otherQ10.2
datatable(otherQ10.2, colnames = c( "other reasons" = "Q_10.2"), options = list(pageLength = 11))
```
...
```{r graph Q11.2 source of advice, echo=FALSE, message=FALSE, warning=TRUE}
...
```{r graph Q11.2 source of advice grower, echo=FALSE, message=FALSE, warning=TRUE}
...
source 1 = 44 NA , source 2 = 47 NA and source 3 = 57
...
data_q12_1summary_agro 
data_q12_1summary_agro<- mutate(data_q12_1summary_agro, names_display = fct_relevel(names_display, 
                                                                      c("Programs",
                                                                        "Shallow", 
                                                                        "Unspecified/random",
                                                                        "All depths",
...
```{r graph - Q12.1 source of advice agro, echo=FALSE, message=FALSE, warning=TRUE}
ggplot(data_q12_1summary_agro, aes(names_display , percent ))+
  geom_col(fill = "grey40", color = "black")+
  #facet_wrap(. ~ Resp_Group)+
  #geom_text(aes(label = percent(signif(percent),1), vjust = -1.0, hjust = 0.5))+
  theme_classic()+
...
```{r Q12.1 source of advice grower, message=FALSE, warning=TRUE, include=FALSE}
...
data_q12_1summary_grower<- mutate(data_q12_1summary_grower, names_display = fct_relevel(names_display, 
                                                                      c("Programs",
                                                                        "Shallow", 
                                                                        "Unspecified/random",
                                                                        "All depths",
...
```{r graph - Q12.1 source of advice grower, echo=FALSE, message=FALSE, warning=TRUE}
ggplot(data_q12_1summary_grower, aes(names_display , percent ))+
  geom_col(fill = "grey70", color = "black")+
  #facet_wrap(. ~ Resp_Group)+
  #geom_text(aes(label = percent(signif(percent),1), vjust = -1.0, hjust = 0.5))+
  theme_classic()+
...
data_q12_2summary_agro<- mutate(data_q12_2summary_agro, names_display = fct_relevel(names_display, 
                                                                      c("Deep",
                                                                        "All depths",
                                                                        "Programs",
                                                                        "Unspecified/random",
...
```{r graph - Q12.2 source of advice agro, echo=FALSE, message=FALSE, warning=TRUE}

ggplot(data_q12_2summary_agro, aes(names_display , percent ))+
  geom_col(fill = "grey70", color = "black")+
  theme_classic()+
  labs(x= "",
       y = "",
...
```{r Q12.2 source of advice grower, message=FALSE, warning=TRUE, include=FALSE}
...
```{r graph - Q12.2 source of advice grower, echo=FALSE, message=FALSE, warning=TRUE}
...
```{r Q12.3 source of advice ago, message=FALSE, warning=TRUE, include=FALSE}
...
data_q12_3summary_agro<- mutate(data_q12_3summary_agro, names_display = fct_relevel(names_display, 
                                                                          c("Plant",
                                                                            "Soil & Plant",
                                                                            "Unspecified/random",
                                                                            "Programs",
...
```{r graph - Q12.3 source of advice agro, echo=FALSE, message=FALSE, warning=TRUE}
ggplot(data_q12_3summary_agro, aes(names_display , percent ))+
  geom_col(fill = "grey70", color = "black")+
  theme_classic()+
  labs(x= "",
       y = "",
...
```{r Q13 graphs and table , echo=FALSE}

datatable(Q13_percent_testing_for_table, 
          colnames = c("type of test" =  "label_name", "respondent" = "Resp_Group", "percent" = "percent1" ), 
...
soil_test_use <- function(data_df, test1, numb_sample_test1, 
  ...
  test1 <-  filter(subset_test1, test == soil_test)
  ...
  test2 <-  filter(subset_test2, test == soil_test)
  ...
  test3 <-  filter(subset_test3, test == soil_test)
...
```{r soil test function - 5 tests, include=FALSE}
...
soil_test_use5_all <- function(data_df, test1, numb_sample_test1, 
 ...
 #test4
  ...
  test4 <-  filter(subset_test4, test == soil_test)
  ...
  test5 <-  filter(subset_test5, test == soil_test)
...
###modification on above function
soil_test_use5_mod <- function(data_df, test1, numb_sample_test1, 
                        test2, numb_sample_test2,
                        test3, numb_sample_test3,
                        test4, numb_sample_test4,
                        #test5, numb_sample_test5,
...
#"DGT"
#"Total P"
soil_test_use5_mod(data, quo(Q_15.1.1), quo(Q_15.1.3), 
...
soil_test_use8_Al <- function(data_df, 
 ...
 #test4
  ...
  test6 <-  filter(subset_test6, test == soil_test)
  ...
  test7 <-  filter(subset_test7, test == soil_test)
  ...
  #  
  # test8 <-  filter(subset_test8, test == soil_test)
...
####slight modification to accomidate missing data!
soil_test_use8_Boron <- function(data_df, 
                        test1, numb_sample_test1, 
                        test2, numb_sample_test2,
                        test3, numb_sample_test3,
                        test4, numb_sample_test4,
...
####slight modification to accomidate NO missing data!
soil_test_use8_CalCarb <- function(data_df, 
                        test1, numb_sample_test1, 
                        test2, numb_sample_test2,
                        test3, numb_sample_test3,
                        test4, numb_sample_test4,
...
####slight modification to accomidate NO missing data!
soil_test_use8_Chloride <- function(data_df, 
                        #test1, numb_sample_test1, 
                        test2, numb_sample_test2,
                        test3, numb_sample_test3,
                        #test4, numb_sample_test4,
...
####slight modification to accomidate  missing data!
soil_test_use8_pH <- function(data_df, 
                        test1, numb_sample_test1, 
                        test2, numb_sample_test2,
                        test3, numb_sample_test3,
                        test4, numb_sample_test4,
...
####slight modification to accomidate  missing data!
soil_test_use8_texture <- function(data_df, 
                        test1, numb_sample_test1, 
                        test2, numb_sample_test2,
                        test3, numb_sample_test3,
                        test4, numb_sample_test4,
...
####slight modification to accomidate  missing data!
soil_test_use8_trace <- function(data_df, 
                        test1, numb_sample_test1, 
                        test2, numb_sample_test2,
                        test3, numb_sample_test3,
                        test4, numb_sample_test4,
...
soil_test_use8_Boron(data_chunck, 
                     quo(Q_17.1.1), quo(Q_17.1.3), 
                     quo(Q_17.2.1), quo(Q_17.2.3),
                     quo(Q_17.3.1), quo(Q_17.3.3),
                     quo(Q_17.4.1), quo(Q_17.4.3),
...
soil_test_use8_CalCarb(data_chunck, 
                     quo(Q_17.1.1), quo(Q_17.1.3), 
                     quo(Q_17.2.1), quo(Q_17.2.3),
                     quo(Q_17.3.1), quo(Q_17.3.3),
                     quo(Q_17.4.1), quo(Q_17.4.3),
...
# Soil test  Chloride
soil_test_use8_Chloride(data_chunck, 
                     #quo(Q_17.1.1), quo(Q_17.1.3), 
                     quo(Q_17.2.1), quo(Q_17.2.3),
                     quo(Q_17.3.1), quo(Q_17.3.3),
                     #quo(Q_17.4.1), quo(Q_17.4.3),
...
soil_test_use8_CalCarb(data_chunck, 
                     ...
                     quo(Q_17.7.1), quo(Q_17.7.3),
                     quo(Q_17.8.1), quo(Q_17.8.3),
                    "Excat", "Exchangable cations - Ca, Mg, Na, K")

# Soil test  pH
soil_test_use8_pH(data_chunck, 
                     quo(Q_17.1.1), quo(Q_17.1.3), 
                     quo(Q_17.2.1), quo(Q_17.2.3),
                     quo(Q_17.3.1), quo(Q_17.3.3),
                     quo(Q_17.4.1), quo(Q_17.4.3),
...
#Texture
soil_test_use8_texture(data_chunck, 
                     quo(Q_17.1.1), quo(Q_17.1.3), 
                     quo(Q_17.2.1), quo(Q_17.2.3),
                     quo(Q_17.3.1), quo(Q_17.3.3),
                     quo(Q_17.4.1), quo(Q_17.4.3),
                    ...
                    "Texture", "Texture")
#Trace elements
soil_test_use8_trace(data_chunck, 
                     quo(Q_17.1.1), quo(Q_17.1.3), 
                     quo(Q_17.2.1), quo(Q_17.2.3),
                     quo(Q_17.3.1), quo(Q_17.3.3),
                     quo(Q_17.4.1), quo(Q_17.4.3),
