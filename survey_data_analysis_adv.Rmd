---
title: "Survey data analysis for: “Using soil and plant testing data to better inform nutrient management and optimise fertiliser investments for grain growers in the southern region"
...
ggplot(Q1_resp_percent, aes(Resp_Group, percent, fill = Resp_Group))+
  ...
  labs(x= "",
       y = "percentage of participants in survey",
       fill = "",
       title = "",
...
#Q3_regions_grower_narrow
datatable(Q3_regions_grower_narrow, 
          options = list(pageLength = 35, dom = 't'),
          colnames = c( "Respondents", "Crop", "Average cropped area"))
...
ggplot(Q4_resp_percent, aes(Q_4, percent, fill =Resp_Group ))+
  ...
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
        scale_y_continuous("Percentage of participants in survey", breaks=seq(0, 1.0, 0.1)
...
```{r Q4 working more grouping2, echo=FALSE}
  ...
  datatable(Q4group_resp_percent,
    options = list(pageLength = 35, dom = 't'),
    colnames = c(
      'Respondent' = 'Resp_Group',
...
ggplot(Q4group_resp_percent, aes(Q_4_group, percent, fill = Resp_Group ))+
  ...
  labs(x= "",
       y = "percent response",
       title = "Percent of annual variable costs attributed to fertilisers - additional grouping",
       #subtitle = "Agronomist and grower",
       caption = "Q)  Of your total annual variable costs, what percentage would fertilisers account for?")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
...
datatable(Q4group_resp__regions_merged_percent,
    options = list(pageLength = 60, dom = 't'),
    colnames = c(
      'Respondent' = 'Resp_Group',
      'Region' = 'region_merge', 
      'Total annual variable costs' = 'Q_4_group',
...
**Question 4 grouped and by rainfall**
...
ggplot( aes(Q_4_group, percent))+
  ...
  facet_wrap(. ~ rainfall)+
  theme_classic()+
  labs(x= "Percentage of participants in survey",
       y = "",
       title = "Percent of annual variable costs attributed to fertilisers - more grouping",
       subtitle = "Grower",
       caption = "Q)  Of your total annual variable costs, what percentage would fertilisers account for?")+
...
## tables
select(nutr_def_all, Resp_Group, nutrient, n, percent) %>%
...
select(Q6_all_agro, Resp_Group, Q_6, n, percent) %>%
  datatable(
    options = list(pageLength = 35, dom = 't'),
    colnames = c(
      'Respondent' = 'Resp_Group',
      'soil and or plant testing' = 'Q_6' ,
      'count' = 'n',
      "percent" = "percent"
    )
  ) %>%
...
select(Q6_by_Region_merge, Resp_Group, region_merge, Q_6, n, percent) %>%
  datatable(
    options = list(pageLength = 35, dom = 't'),
    colnames = c(
      'Respondent' = 'Resp_Group',
...
ggplot(Q7, aes(Q_7 , percent ))+
  ...
  theme_classic()+
  labs(x= "",
       y = "Percentage of respondents to question",
       fill = "",
...
ggplot(Q8_1_3, aes(bin , percent))+
  ...
  labs(x= "",
       y = "Percentage of respondents to question",
       fill = "",
       title = "Rely on agronomist to make nutrient decisions?",
       subtitle = "Agronomist only",
       caption = "Q) Of your clients, how many of them rely entirely on you to make the nutrient decisions?
       Q) Of your clients, how many of them rely somewhat on you to make the nutrient decisions?
       Q) of your clients, how many of them make their own nutrient decisions?")+
  theme(axis.text.x=element_text(angle=45,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L), limits=c(0, 0.8))
...
select(Q9_1, Resp_Group, Q_9.1,  n, percent  ) %>% 
  datatable(options = list(pageLength = 35, dom = 't'),
            colnames = c('Respondent' = 'Resp_Group', 
                         'Extent of testing' = 'Q_9.1',
                         "count" = "n",
                         "Percent" = "percent")) %>% 
  formatPercentage('Percent', 0)
...
ggplot(Q9_1, aes(Q_9.1 , percent, fill =  Resp_Group))+
  ...
  #geom_text(aes(label = percent(signif(percent),1), vjust = -1.0, hjust = 0.5))+
  theme_classic()+
  labs(x= "Percentage of respondents to question",
       y = "Percentage of respondents to question",
       fill = "",
...
datatable(options = list(pageLength = 35, dom = 't'),
   colnames = c( "Other reasons / comments" = "Q_9.2", 'Respondent' = 'Resp_Group'))   
...
datatable(Q10_1, options = list(pageLength = 35, dom = 't'),
            colnames = c( "Extent of influence" = "Q_10.1", "Respondent" = "Resp_Group", "count" = "n")) %>% 
    formatPercentage('percent', 0)  
...
#table
  ...
  datatable(Q10_1_group_df, options = list(pageLength = 35, dom = 't'),
            colnames = c( "Extent of influence - additional grouping" = "Q_10_1group", 
                          "Respondent" = "Resp_Group", "count" = "n")) %>% 
    formatPercentage('percent', 0)  
...
ggplot(Q10_1_group_df, aes(Q_10_1group , percent, fill = Resp_Group ))+
  ...
  labs(x= "",
       ...
       subtitle = "",
       caption = "Q) To what extent do the test results influence your recommendations?
                   Q)  To what extent does your agronomist make recommendations based on the test results from your farm? ")+
...
datatable(data_q12_1summary_agro_grower,
            ...
            # caption = "Grower",
             colnames = c( "Respondent" = "Resp_Group",
                           "Approach to P soil testing" = "names_display",
                           "count" = "n",
                           "percent" = "percent")) %>%
...
datatable(data_q12_2summary_agro_grower,
          ...
          # caption = "Grower",
          colnames = c( "Respondent" = "Resp_Group",
                        "Approach to N soil testing" = "names_display",
                        "count" = "n",
                        "percent" = "percent")) %>%
  formatPercentage(c("percent"), 0)
...
datatable(data_q12_3summary_agro_grower,
          options = list(pageLength = 35, dom = 't'),
          # caption = "Grower",
          colnames = c( "Respondent" = "Resp_Group",
                        "Approach to Mirconutrients soil testing" = "names_display",
                        "count" = "n",
                        "percent" = "percent")) %>%
  formatPercentage(c("percent"), 0)
...
* The response to the question from the survey participants changes with the 3 questions asked.
...
labels <- c(percent_N_testing_2018 = "N", 
            ...
            percent_testing_2018 = "soil tested")
...
Q13_percent_testing_for_table <- mutate(Q13_percent_testing,
                                        ...
                                        label_name = case_when(
                                          ...
                                          type == "percent_testing_2018" ~ "soil tested")) %>% 
...
```{r Q13 graphs and table ago, echo=FALSE, warning=FALSE}
##Table
...
datatable( 
 ...
 ### plots 
  ...
  filter(Q13_percent_testing, bin_as_factors != "NA" &
    ...
    labs(x= "",
         y = "Percentage of respondents to question",
         title = "In 2018 what % of your clients soil tested for...",
         subtitle = "Agronomist",
...
```{r Q13 graphs and table grower, echo=FALSE, warning=FALSE}
select(Q13_percent_testing_for_table,Resp_Group, label_name, bins,  n, percent1 ) %>% 
  filter(Resp_Group == "Grower" ) %>% 
datatable( 
          colnames = c("Type of test" =  "label_name", 
  ...
  filter(Q13_percent_testing, bin_as_factors != "NA" &
    ...
    labs(x= "bins",
         y = "Percentage of respondents to question",
         title = "In 2018 what % of your cropped land was soil tested for...",
         subtitle = "Grower",
...
Additional grouping to make the answer easier to interpenetrate.
...
```{r graph - Q13 grouping other agro options, echo=FALSE}
...
filter(subset_soil_N_P_Any_Q_13_wide, Resp_Group == "Agronomist") %>%
  datatable(
    colnames = c(
      "bins" =  "bins",
      "respondent" = "Resp_Group",
      "soil testing" = "percent_testing_2018",
      "N" = "percent_N_testing_2018",
      "P" = "percent_P_testing_2018",
      "count soil test" = "test",
      "count N test" = "n_test",
      "count P test" = "p_test"
    ),
    options = list(pageLength = 35,  dom = 't'),
  ...
  formatPercentage(c("soil testing",
                     "N",
                     "P"))
...
```{r graph - Q13 grouping other grower options, echo=FALSE}
############ Grower
...
* I have tried to take out the percentage of percentage graph, by grouping the data.
...
This just mean that I am calculating the percentage based on all the people that respondend to the question (but not the NA)
...
#Add in how many people in each group to cal the % for all survey partipants
N_test_counts <- N_test_counts %>% 
  mutate(Resp_numb = case_when(
    Resp_Group == "Agronomist" ~ 71,
    Resp_Group == "Grower"  ~ 99
  ),
  percent_all = n/Resp_numb
  )
N_test_counts #This is one data set to plot......
...
OC_numb <- test_OC %>%
  ...
  filter(!is.na(test)) %>%
  group_by(Resp_Group, numb_of_test) %>%
  count(numb_of_test) 
MN_numb <- test_MN %>%
  filter(!is.na(numb_of_test)) %>%
  filter(!is.na(test)) %>%
...
N_test_numb_counts
N_test_numb_counts <- group_by(N_test_numb_counts, Resp_Group, numb_of_test) %>%
  summarise(number_test_all = sum(n))
...
N_test_numb_counts <- N_test_numb_counts %>%
  group_by(Resp_Group) %>% 
 mutate(count_all_test_all_depth = sum(number_test_all),
        perecnt = number_test_all / count_all_test_all_depth)
N_test_numb_counts
...
N_test_numb_counts <- N_test_numb_counts %>% 
  mutate(Resp_numb = case_when(
   ...
   percent_all = number_test_all/(Resp_numb)
   )


N_test_numb_counts #This is one data set to plot......


```


```{r Q14 data table type graphs N, echo=FALSE}
### Tables for type of test used...

filter(N_test_counts, Resp_Group == "Agronomist") %>% 
select(Resp_Group, test , n,   percent, percent_all) %>%
  datatable( colnames = c("Respondent" = "Resp_Group",
                          "count" = "n",
                          "test" = "test" ,
                          "percent" = "percent",
                          "percent of all participants" = "percent_all"
                          ),
             options = list(pageLength = 35,  dom = 't'),
             caption = "Type of test used - Agronomist")%>%
  formatPercentage(c("percent", "percent of all participants"
  ))

filter(N_test_counts, Resp_Group == "Grower") %>% 
  select(Resp_Group, test , n,   percent, percent_all) %>%
  datatable( colnames = c("Respondent" = "Resp_Group",
                          "count" = "n",
                          "test" = "test" ,
  ...
  options = list(pageLength = 35,  dom = 't'),
  caption = "Type of test used - Grower")%>%
  formatPercentage(c("percent", "percent of all participants"
  ))
...
ggplot(N_test_counts, aes (x = test, y = percent, fill = Resp_Group))+
  ...
  theme_classic()+
  labs(x= "",
       y = "Percentage of tests nominated ",
       title = "N test used",
       subtitle = "",
...
```{r Q14 data graphs freq N, echo=FALSE}
##Table for frquency
filter(N_test_numb_counts, Resp_Group == "Agronomist") %>% 
select(Resp_Group , numb_of_test, number_test_all , perecnt , percent_all) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                          "number of sample (all types of tests)" = "number_test_all",
                          "numb of test" = "numb_of_test" ,
                          "percent" = "perecnt",
                          "percent of all participants" = "percent_all"
                          ),
             options = list(pageLength = 35,  dom = 't'),
             caption = "number of sample taken for all N tests - Agronomist")%>%
  formatPercentage(c("percent", "percent of all participants"))


filter(N_test_numb_counts, Resp_Group == "Grower") %>% 
  select(Resp_Group , numb_of_test, number_test_all , perecnt , percent_all) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "number of sample (all types of tests)" = "number_test_all",
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "number of sample taken for all N tests - Grower")%>%
  formatPercentage(c("percent", "percent of all participants"))
...
ggplot(N_test_numb_counts, aes(numb_of_test, perecnt, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(.~ Resp_Group )+
  theme_classic()+
  labs(x= "Number of samples per paddock",
       y = "",
       title = "Representative samples per paddock – N tests",
       subtitle = "",
       caption = "Q)  How many representative samples per paddock for soil N testing?")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L))
...
NB the perecenatge are expressed as:

* N test - all the nomintaed n tests used (some people use more than 1) total is 116
If you want as a percenatge of participants in survey, this inormation is in the table.
* The number of representative samples per paddock for N test
 - all the answeres to this question are used accross all the types of n tests (some people use more than 1) total number of answeres to this question is 95. This is confusing, and example might help: for all the 3 types of N tests 20 agronomist said they take between 0-5 tests per paddock, so this is 20/95 =21%
 
If you want as a percenatge of participants in survey, this inormation is in the table.

The same appoach is taken for P soil testing, K soil testing and micro nutrients.
...
P_test_numb_counts <- group_by(P_test_numb_counts, Resp_Group, numb_of_test) %>%
  summarise(number_test_all = sum(n))
P_test_numb_counts
...
```{r graph _Q15 P, echo=FALSE}

### Tables for type of test used...

filter(P_test_counts, Resp_Group == "Agronomist") %>% 
select(Resp_Group, test , n,   percent, percent_all) %>%
  datatable( colnames = c("Respondent" = "Resp_Group",
                          "count" = "n",
                          "test" = "test" ,
...
filter(P_test_counts, Resp_Group == "Grower") %>% 
  select(Resp_Group, test , n,   percent, percent_all) %>%
  datatable( colnames = c("Respondent" = "Resp_Group",
                          "count" = "n",
                          "test" = "test" ,
...
```{r Q14 data graphs freq P, echo=FALSE, warning=FALSE}
##Table for frquency
filter(P_test_numb_counts, Resp_Group == "Agronomist") %>% 
select(Resp_Group , numb_of_test, number_test_all , perecnt , percent_all) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                          "number of sample (all types of tests)" = "number_test_all",
             ...
             options = list(pageLength = 35,  dom = 't'),
             caption = "number of sample taken for all P tests - Agronomist")%>%
  formatPercentage(c("percent", "percent of all participants"))


filter(P_test_numb_counts, Resp_Group == "Grower") %>% 
  select(Resp_Group , numb_of_test, number_test_all , perecnt , percent_all) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "number of sample (all types of tests)" = "number_test_all",
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "number of sample taken for all P tests - Grower")%>%
  formatPercentage(c("percent", "percent of all participants"))
...
#percent of people in survey using sampling at certain density - number of samples per paddock
ggplot(P_test_numb_counts, aes(numb_of_test, perecnt, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(.~ Resp_Group )+
  theme_classic()+
  labs(x= "Number of samples per paddock",
       y = "",
       title = "Representative samples per paddock – P tests",
       subtitle = "",
       caption = "Q) How many representative samples per paddock for soil N testing?")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
...
soil_test_use2_all(data, quo(Q_16.1.1), quo(Q_16.1.3), 
                   quo(Q_16.2.1), quo(Q_16.2.3),
                   "test_EXC", "Exchangable Cations (Ca, Mg, K, Na)")
...
K_test_numb_counts
###ADD this in 12/12
K_test_numb_counts <- group_by(K_test_numb_counts, Resp_Group, numb_of_test) %>%
  summarise(number_test_all = sum(n))
K_test_numb_counts
...
```{r graph and table test _Q16 K, echo=FALSE}
# table
### Tables for type of test used...

filter(K_test_counts, Resp_Group == "Agronomist") %>% 
select(Resp_Group, test , n,   percent, percent_all) %>%
  datatable( colnames = c("Respondent" = "Resp_Group",
                          "count" = "n",
                          "test" = "test" ,
...
filter(K_test_counts, Resp_Group == "Grower") %>% 
  select(Resp_Group, test , n,   percent, percent_all) %>%
  datatable( colnames = c("Respondent" = "Resp_Group",
                          "count" = "n",
                          "test" = "test" ,
...
```{r graph and table test _Q16 K a, echo=FALSE}
# table
 ##Table for frquency
filter(K_test_numb_counts, Resp_Group == "Agronomist") %>% 
select(Resp_Group , numb_of_test, number_test_all , perecnt , percent_all) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                          "number of sample (all types of tests)" = "number_test_all",
             ...
             options = list(pageLength = 35,  dom = 't'),
             caption = "number of sample taken for all K tests - Agronomist")%>%
  formatPercentage(c("percent", "percent of all participants"))


filter(K_test_numb_counts, Resp_Group == "Grower") %>% 
  select(Resp_Group , numb_of_test, number_test_all , perecnt , percent_all) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "number of sample (all types of tests)" = "number_test_all",
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "number of sample taken for all K tests - Grower")%>%
  formatPercentage(c("percent", "percent of all participants"))
...
#percent of people in survey using sampling at certain density - number of samples per paddock
ggplot(K_test_numb_counts, aes(numb_of_test, perecnt, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(.~ Resp_Group )+
  theme_classic()+
  labs(x= "Number of samples per paddock",
       y = "",
       title = "Representative samples per paddock – K tests",
       subtitle = "",
       caption = "Q) How many representative samples per paddock for soil K testing?")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L))
...
###ADD this in 12/12
mirco_test_numb_counts <- group_by(mirco_test_numb_counts, Resp_Group, numb_of_test) %>%
  summarise(number_test_all = sum(n))
...
```{r graph type _Q1 mirco, echo=FALSE}
### Tables for type of test used...

filter(mirco_test_counts, Resp_Group == "Agronomist") %>% 
select(Resp_Group, test , n,   percent, percent_all) %>%
  datatable( colnames = c("Respondent" = "Resp_Group",
                          "count" = "n",
                          "test" = "test" ,
...
filter(mirco_test_counts, Resp_Group == "Grower") %>% 
  select(Resp_Group, test , n,   percent, percent_all) %>%
  datatable( colnames = c("Respondent" = "Resp_Group",
                          "count" = "n",
                          "test" = "test" ,
...
ggplot(mirco_test_counts, aes (x = test, y = percent, fill = Resp_Group))+
  ...
  labs(x= "",
       y = "Percentage of tests nominated ",
       title = "mirco nutrients test used",
       subtitle = "",
       caption = "Q)  Which tests do you currently use for your soil micro nutrient testing?")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
...
```
```{r graph freq _Q1 mirco, echo=FALSE}


 ##Table for frquency
filter(mirco_test_numb_counts, Resp_Group == "Agronomist") %>% 
select(Resp_Group , numb_of_test, number_test_all , perecnt , percent_all) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                          "number of sample (all types of tests)" = "number_test_all",
             ...
             options = list(pageLength = 35,  dom = 't'),
             caption = "number of sample taken for all mirco tests - Agronomist")%>%
  formatPercentage(c("percent", "percent of all participants"))


filter(mirco_test_numb_counts, Resp_Group == "Grower") %>% 
  select(Resp_Group , numb_of_test, number_test_all , perecnt , percent_all) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "number of sample (all types of tests)" = "number_test_all",
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "number of sample taken for all micro tests - Grower")%>%
  formatPercentage(c("percent", "percent of all participants"))



# df needs ording for display
mirco_test_numb_counts$numb_of_test <- factor(mirco_test_numb_counts$numb_of_test,levels = c("0-5",  "5-10", "10-15", 
                                                                                             "15-20", "20-25",  "25-30", 
                                                                                             "greater than 30"))

#percent of people in survey using sampling at certain density - number of samples per paddock
ggplot(mirco_test_numb_counts, aes(numb_of_test, perecnt, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(.~ Resp_Group )+
  theme_classic()+
  labs(x= "Number of samples per paddock",
       y = "",
       title = "Representative samples per paddock – Mirco nutrients tests",
       subtitle = "",
       caption = "Q) How many representative samples per paddock for soil micro nutrient testing?")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L))
...
```{r Q18 working, warning=FALSE, include=FALSE}
headers18_1 <- read_excel("Q18_Top_3_Categories _ 12.12.19.xlsx", 
                          sheet = "Q18_categories", col_names=FALSE, range = "B4:E4")

head(headers12_2)

data_q18_1 <- read_excel("Q18_Top_3_Categories _ 12.12.19.xlsx", 
                         sheet = "Q18_categories", col_names=FALSE, range = "B5:E174")
names(data_q18_1) <- headers18_1

head(data_q18_1)


data_q18_1
colnames(data_q18_1)[4] <- "Categories"
data_q18_1 <- select(data_q18_1, Resp_Group, Categories)
data_q18_1summary_agro <- filter (data_q18_1, Resp_Group == "Agronomist" & Categories !=  "NA")%>%
  group_by(Resp_Group) %>%
  count(Categories) %>% 
  mutate(percent = 
           (freq = n / sum(n))) %>% 
  arrange(desc(percent))
data_q18_1summary_agro



data_q18_1summary_grower <- filter (data_q18_1, Resp_Group == "Grower" & Categories !=  "NA")%>%
  group_by(Resp_Group) %>%
  count(Categories) %>% 
  mutate(percent = 
           (freq = n / sum(n))) %>% 
  arrange(desc(percent))
data_q18_1summary_grower



data_q18_1summary_agro_grower <- rbind(data_q18_1summary_grower, data_q18_1summary_agro)


```

```{r Q18 table reason 1, echo=FALSE, warning=FALSE}

datatable(data_q18_1summary_agro_grower,
          options = list(pageLength = 35, dom = 't'),
           caption = "Top reason for soil testing",
          colnames = c( "Respondent" = "Resp_Group",
                        "Reason" = "Categories",
                        "count" = "n",
                        "percent" = "percent")) %>%
...
```{r Q18 working reason 2, warning=FALSE, include=FALSE}

headers18_2 <- read_excel("Q18_Top_3_Categories _ 12.12.19.xlsx", 
                          sheet = "Q18_categories", col_names=FALSE, range = "B4:G4")

data_q18_2 <- read_excel("Q18_Top_3_Categories _ 12.12.19.xlsx", 
                         sheet = "Q18_categories", col_names=FALSE, range = "B5:G174")
names(data_q18_2) <- headers18_2

names(data_q18_2)
data_q18_2 <- select(data_q18_2, "Resp_Group", 'Q_18.2_ Categories')
data_q18_2

colnames(data_q18_2)[2] <- "Categories"
data_q18_2 <- select(data_q18_2, Resp_Group, Categories)
data_q18_2summary_agro <- filter (data_q18_2, Resp_Group == "Agronomist" & Categories !=  "NA")%>%
  group_by(Resp_Group) %>%
  count(Categories) %>% 
  mutate(percent = 
           (freq = n / sum(n))) %>% 
  arrange(desc(percent))
data_q18_2summary_agro



data_q18_2summary_grower <- filter (data_q18_2, Resp_Group == "Grower" & Categories !=  "NA")%>%
  group_by(Resp_Group) %>%
  count(Categories) %>% 
  mutate(percent = 
           (freq = n / sum(n))) %>% 
  arrange(desc(percent))
data_q18_2summary_grower



data_q18_2summary_agro_grower <- rbind(data_q18_2summary_grower, data_q18_2summary_agro)

```


```{r Q18 table reason 2, echo=FALSE, warning=FALSE}

datatable(data_q18_2summary_agro_grower,
          options = list(pageLength = 35, dom = 't'),
           caption = "Second reason for soil testing",
          colnames = c( "Respondent" = "Resp_Group",
                        "Reason" = "Categories",
                        "count" = "n",
                        "percent" = "percent")) %>%
...
```{r Q18 reason 3 working, warning=FALSE, include=FALSE}
headers18_3 <- read_excel("Q18_Top_3_Categories _ 12.12.19.xlsx", 
                          sheet = "Q18_categories", col_names=FALSE, range = "B4:I4")



data_q18_3 <- read_excel("Q18_Top_3_Categories _ 12.12.19.xlsx", 
                         sheet = "Q18_categories", col_names=FALSE, range = "B5:I174")
names(data_q18_3) <- headers18_3

names(data_q18_3)
data_q18_3 <- select(data_q18_3, "Resp_Group", 'Q_18.3_ Categories')
data_q18_3

colnames(data_q18_3)[2] <- "Categories"
data_q18_3 <- select(data_q18_3, Resp_Group, Categories)
data_q18_3summary_agro <- filter (data_q18_3, Resp_Group == "Agronomist" & Categories !=  "NA")%>%
  group_by(Resp_Group) %>%
  count(Categories) %>% 
  mutate(percent = 
           (freq = n / sum(n))) %>% 
  arrange(desc(percent))
data_q18_3summary_agro



data_q18_3summary_grower <- filter (data_q18_3, Resp_Group == "Grower" & Categories !=  "NA")%>%
  group_by(Resp_Group) %>%
  count(Categories) %>% 
  mutate(percent = 
           (freq = n / sum(n))) %>% 
  arrange(desc(percent))
data_q18_3summary_grower



data_q18_3summary_agro_grower <- rbind(data_q18_3summary_grower, data_q18_3summary_agro)

```


```{r Q18 table reason 3, echo=FALSE, warning=FALSE}
datatable(data_q18_3summary_agro_grower,
          options = list(pageLength = 35, dom = 't'),
           caption = "Third reason for soil testing",
          colnames = c( "Respondent" = "Resp_Group",
                        "Reason" = "Categories",
                        "count" = "n",
                        "percent" = "percent")) %>%
...
#### **Comments notes on Question 18** 

* The responses are varied, therefore only tables were made.
...
```{r function for to cal the % of respnondents, include=FALSE}
...
```{r graphs and table Q19, echo=FALSE}
#text is too long
...
filter(reason_soil_N, Resp_Group == "Agronomist") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
                 "count" = "n" ,
                 "percent" = "percent"
    ),
    options = list(pageLength = 35,  dom = 't'),
    caption = "Reason for not doing more Soil N testing -Agronomist")%>%
  formatPercentage(c("percent"))

filter(reason_soil_N, Resp_Group == "Grower") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "Reason for not doing more Soil N testing - Grower")%>%
  formatPercentage(c("percent"))
...
### table
filter(reason_soil_P, Resp_Group == "Agronomist") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "Reason for not doing more Soil P testing - Agronomist")%>%
  formatPercentage(c("percent"))

filter(reason_soil_P, Resp_Group == "Grower") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "Reason for not doing more Soil P testing - Grower")%>%
  formatPercentage(c("percent"))
...
subsetQ21.1_summary <- ungroup(subsetQ21.1_summary)
subsetQ21.1_summary <- select(subsetQ21.1_summary , -"Q_21.1")
subsetQ21.2_summary <- ungroup(subsetQ21.2_summary)
subsetQ21.2_summary <- select(subsetQ21.2_summary , -"Q_21.2")
subsetQ21.3_summary <- ungroup(subsetQ21.3_summary)
subsetQ21.3_summary <- select(subsetQ21.3_summary , -"Q_21.3")
subsetQ21.4_summary <- ungroup(subsetQ21.4_summary)
subsetQ21.4_summary <- select(subsetQ21.4_summary , -"Q_21.4")
...
#                             question,scale)
 subsetQ21_summary$question
unique(subsetQ21_summary$question)
...
```{r Q21 graph profitable, echo=FALSE}
# df needs ording for display
...
filter(subsetQ21_summary,
       Resp_Group == "Agronomist" &
         question == "more profitable") %>%
  select(Resp_Group, scale, n, percent_of_numb_resp, question) %>%
  datatable(
    colnames = c(
      "Respondent" = "Resp_Group",
      "scale" = "scale",
      "count" = "n" ,
      "percent" = "percent_of_numb_resp",
      "question" = "question"
    ),
    options = list(pageLength = 35,  dom = 't'),
    caption = "more profitable - Agronomist")%>%
  formatPercentage(c("percent"))

#  more profitable table 2
filter(subsetQ21_summary,
       Resp_Group == "Grower" &
         question == "more profitable") %>%
  select(Resp_Group, scale, n, percent_of_numb_resp, question) %>%
  datatable(
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "more profitable - Grower")%>%
  formatPercentage(c("percent"))

#  more profitable graph
filter(subsetQ21_summary, question == "more profitable" ) %>% 
ggplot( aes (x =  reorder(scale, -percent_of_numb_resp), y = percent_of_numb_resp, 
                               fill = Resp_Group))+
  geom_col() +
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(.~ Resp_Group )+
  ...
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "More profitable with more soil testing",
       subtitle = "",
       caption = "Q)My clients businesses would be more profitable if they did more soil testing than they do now")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
...
```{r Q21 graph Uncertainty, echo=FALSE}
###################################################################################################
...
filter(subsetQ21_summary,
  ...
  datatable(
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "Uncertainty - Agronomist")%>%
  formatPercentage(c("percent"))
...
filter(subsetQ21_summary,
  ...
  datatable(
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "Uncertainty - Grower")%>%
  formatPercentage(c("percent"))

#  more profitable graph
filter(subsetQ21_summary, question == "Uncertainty" ) %>% 
ggplot( aes (x =  reorder(scale, -percent_of_numb_resp), y = percent_of_numb_resp, 
                               fill = Resp_Group))+
  geom_col() +
  scale_fill_manual(values=c("grey70", "grey40"))+
  ...
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "Uncertainty about the season will reduces value of soil testing ",
       subtitle = "",
       caption = "Q)Uncertainty about how the season will turn out makes it hard to get value from soil testing results")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
...
```{r Q21 graph recommend, echo=FALSE}
######################################################################################
...
filter(subsetQ21_summary,
  ...
  datatable(
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "recommend - Grower")%>%
  formatPercentage(c("percent"))
# graph recommend
filter(subsetQ21_summary, question == "recommend" ) %>% 
ggplot( aes (x =  reorder(scale, -percent_of_numb_resp), y = percent_of_numb_resp, 
                               fill = Resp_Group))+
  geom_col() +
  scale_fill_manual(values=c("grey70", "grey40"))+
  ...
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "Recommend regular soil testing to others",
       subtitle = "",
       caption = "Q)My clients recommend the use of regular soil testing to other local farmers")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
```
...
```{r Q21 graph profitability, echo=FALSE}
#############################################################################################################



#my profitability table 1
filter(subsetQ21_summary,
       Resp_Group == "Agronomist" &
         question == "my profitability ") %>%
  select(Resp_Group, scale, n, percent_of_numb_resp, question) %>%
  datatable(
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "my profitability - Agronomist")%>%
  formatPercentage(c("percent"))

#my profitability table 2
filter(subsetQ21_summary,
       Resp_Group == "Grower" &
         question == "my profitability ") %>%
  select(Resp_Group, scale, n, percent_of_numb_resp, question) %>%
  datatable(
    ...
    options = list(pageLength = 35,  dom = 't'),
    caption = "my profitability - Grower")%>%
  formatPercentage(c("percent"))



# graph my profitability
filter(subsetQ21_summary, question == "my profitability " ) %>% 
ggplot( aes (x =  reorder(scale, -percent_of_numb_resp), y = percent_of_numb_resp, 
                               fill = Resp_Group))+
  geom_col() +
  scale_fill_manual(values=c("grey70", "grey40"))+
  ...
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "Soil testing increases my profitability",
       subtitle = "",
       caption = "Q)The use of soil testing on my farm increases my profitability (Grower only Q)")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
...
```{r Q21 graph comments, echo=FALSE}



#table
  otherQ21.5 <- filter(data, Q_21.5 !=  "NA") %>% select(Resp_Group, Q_21.5 )
  
  datatable(otherQ21.5, options = list(pageLength = 35, dom = 't'),
            colnames = c( "Comments" = "Q_21.5", 
                          "Respondent" = "Resp_Group")) 
...
```{r Q22 working, warning=FALSE, include=FALSE}

data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_22.1 = sum(!is.na(Q_22.1)))

test_Q22 <- select(data, Resp_Group, Q_22.1)
test_Q22
test_Q221 <-  filter (test_Q22,   Q_22.1 !=  "NA") %>%
  mutate(
    Q_22.1_recode = case_when(
      Q_22.1 ==   "0" ~  "< $2500",
      Q_22.1 == 	'$1 - $2,500'  ~  "< $2500",
      Q_22.1 == 	'$2,500 - $5,000'  ~  "> $2500",
      Q_22.1 == 	'$15,000 - $17,500'  ~  "> $2500",
      Q_22.1 == 	'$5,000 - $7,500'  ~  "> $2500",
      Q_22.1 == 	'$10,000 - $12,500'  ~  "> $2500",
      Q_22.1 == 	'$17,500 - $20,000'  ~  "> $2500",
      Q_22.1 == 	'$7,500 - $10,000'  ~  "> $2500",
      TRUE ~ "****"
    )
  )
#no idea why I can't get it to recode what I want???
test_Q22 <-  test_Q221 %>%
  mutate(
    Q_22.1_recode = case_when(
      Q_22.1_recode ==   "****" ~  "< $2500",
...
```{r Q22 table and graph, echo=FALSE}
datatable(test_Q22_summary, options = list(pageLength = 35, dom = 't'),
          colnames = c( "spend" = "Q_22.1_recode", "Respondent" = "Resp_Group", "count" = "n")) %>% 
  formatPercentage('percent', 0)  



ggplot(test_Q22_summary, aes(Q_22.1_recode , percent, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(. ~ Resp_Group)+
  theme_classic()+
  labs(x= "Average spend each year",
       y = "Percentage of respondents to question",
       fill = "",
       title = "Spend per year",
       subtitle = "",
       caption = "Q)On average, how much would your clients spend each year on soil testing (including sampling)?")+
...
```{r Q22.2 graph comments, echo=FALSE}



#table
  otherQ22.2 <- filter(data, Q_22.2 !=  "NA") %>% select(Resp_Group, Q_22.2 )
  
  datatable(otherQ22.2, options = list(pageLength = 35, dom = 't'),
            colnames = c( "Comments" = "Q_22.2", 
                          "Respondent" = "Resp_Group")) 
...
```{r Q23 working, warning=FALSE, include=FALSE}
data$Q_23.1
unique(data$Q_23.1)
data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_23.1 = sum(!is.na(Q_23.1)))

test_Q23 <- select(data, Resp_Group, Q_23.1)
test_Q23
test_Q23_summary <- 
  filter(test_Q23, Q_23.1 != "NA") %>% 
  group_by( Resp_Group) %>%
  count(Q_23.1) %>% 
  mutate(percent = 
           (freq = n / sum(n)))
...
```{r Q23 table and graph, echo=FALSE}

datatable(test_Q23_summary, options = list(pageLength = 35, dom = 't'),
          colnames = c( "compared to 5 years ago" = "Q_23.1", "Respondent" = "Resp_Group", "count" = "n")) %>% 
  formatPercentage('percent', 0)  



ggplot(test_Q23_summary, aes(Q_23.1 , percent, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(. ~ Resp_Group)+
  theme_classic()+
  labs(x= "",
       y = "Percentage of respondents to question",
       fill = "",
       title = "Change in the amount of soil testing",
       subtitle = "",
       caption = "Q) Compared to five years' ago, has the amount of soil testing you do / recommend changed?")+
...
```{r Q23.2 graph comments, echo=FALSE}



#table
  otherQ23.2 <- filter(data, Q_23.2 !=  "NA") %>% select(Resp_Group, Q_23.2 )
  
  datatable(otherQ23.2, options = list(pageLength = 35, dom = 't'),
            colnames = c( "Comments" = "Q_23.2", 
                          "Respondent" = "Resp_Group")) 
...
```{r Q24 working, warning=FALSE, include=FALSE}

data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_24.1 = sum(!is.na(Q_24.1)))

test_Q24 <- select(data, Resp_Group, Q_24.1)
test_Q24
test_Q24_summary <- 
  filter(test_Q24, Q_24.1 != "NA") %>% 
  group_by( Resp_Group) %>%
  count(Q_24.1) %>% 
  mutate(percent = 
           (freq = n / sum(n)))
...
```{r Q24 table and graph, echo=FALSE}

datatable(test_Q24_summary, options = list(pageLength = 35, dom = 't'),
          colnames = c( "In to 5 years" = "Q_24.1", "Respondent" = "Resp_Group", "count" = "n")) %>% 
  formatPercentage('percent', 0)  

ggplot(test_Q24_summary, aes(Q_24.1 , percent, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(. ~ Resp_Group)+
  theme_classic()+
  labs(x= "",
       y = "Percentage of respondents to question",
       fill = "",
       title = "Future soil testing",
       subtitle = "",
       caption = "Q) In five years' time, how much soil sampling do you expect to be doing / recommending?")+
...
# PLANT TESTING 
We will now ask a few questions about how you use plant testing ... If you have not done any plant testing, please go to page 8.

#### **Question 25**
How do you currently use plant testing?

```{r Q25.0 graph comments, echo=FALSE}



#table
  Q25 <- filter(data, Q_25 !=  "NA") %>% select(Resp_Group, Q_25 )
  
  datatable(Q25, options = list(pageLength = 35, dom = 't'),
            colnames = c( "Comments" = "Q_25", 
                          "Respondent" = "Resp_Group")) 


```

Only 14 text responses here.


#### **Question 26**
Please list the main 3 reasons you use plant testing data?

```{r Q26 working, warning=FALSE, include=FALSE}
headers25_1 <- read_excel("Q26_text_question.xlsx", 
                          sheet = "Data", col_names=FALSE, range = "A4:E4")



data_q25_1 <- read_excel("Q26_text_question.xlsx", 
                         sheet = "Data", col_names=FALSE, range = "A5:E174")
names(data_q25_1) <- headers25_1


data_q25_1 <- select(data_q25_1, - "Q_25_reason1")


data_q25_1summary_agro <- filter (data_q25_1, Resp_Group == "Agronomist" & Q_25_reason12_coded  !=  "NA")%>%
  group_by(Resp_Group) %>%
  count(Q_25_reason12_coded) %>% 
  mutate(percent = 
           (freq = n / sum(n))) %>% 
  arrange(desc(percent))
data_q25_1summary_agro


```

```{r Q26 graph and tables, echo=FALSE, warning=FALSE}
data_q25_1summary_grower <- filter (data_q25_1, Resp_Group == "Grower" & Q_25_reason12_coded !=  "NA")%>%
  group_by(Resp_Group) %>% 
  count(Q_25_reason12_coded) %>% 
  mutate(percent = 
           (freq = n / sum(n))) %>% 
...
datatable(data_q25_1summary_agro,
          options = list(pageLength = 35, dom = 't'),
          caption = "Agronomist",
          colnames = c( "Respondent" = "Resp_Group",
                        "Reason for plant testing" = "Q_25_reason12_coded",
                        "count" = "n",
                        "percent" = "percent")) %>%
  formatPercentage(c("percent"), 0)

ggplot(data_q25_1summary_agro, aes(Q_25_reason12_coded , percent, fill = Resp_Group  )) +
  scale_fill_manual(values=c("grey70", "grey40"))+
  geom_col()+
  facet_wrap(. ~ Resp_Group)+
  #geom_text(aes(label = percent(signif(percent),1), vjust = -1.0, hjust = 0.5))+
  ...
  labs(x= "",
       y = "Percentage of respondents to question",
       fill = "",
       title = "Top reason for plant testing",
       subtitle = "",
       caption = "Q) .Please list the main 3 reasons you use plant testing data?")+
  theme(axis.text.x=element_text(angle=45,hjust=1),
        plot.caption = element_text(size = 8),
        legend.position =  "") + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L), limits=c(0, 0.8))

datatable(data_q25_1summary_grower,
          options = list(pageLength = 35, dom = 't'),
          caption = "Grower",
          colnames = c( "Respondent" = "Resp_Group",
                        "Reason for plant testing" = "Q_25_reason12_coded",
...
ggplot(data_q25_1summary_grower, aes(Q_25_reason12_coded , percent, fill = Resp_Group  )) +
  scale_fill_manual(values=c("grey70", "grey40"))+
  geom_col()+
  facet_wrap(. ~ Resp_Group)+
  #geom_text(aes(label = percent(signif(percent),1), vjust = -1.0, hjust = 0.5))+
...
```{r Q27.0 working comments, include=FALSE}

##function for to cal the % of respnondents This was defined above
# summary_stats_all_resp <- function(df, group_by, clm_in_df){
#   df <- filter( df, !! clm_in_df != "NA") %>%
#     group_by(!! group_by) %>%
#     count(!! clm_in_df) %>%
...
Plant_cost <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_27.1))
Plant_time <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_27.2))
Plant_lab_cost <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_27.3))
Plant_variability <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_27.4))
Plant_accuracy_lab <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_27.5))
Plant_accuracy_decision <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_27.6))
Plant_accuracy_timing <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_27.7))

#join the reasons together

reason_plant_testing <- rbind(Plant_cost, 
                              Plant_time,
                              Plant_lab_cost,
                              Plant_variability,
                              Plant_accuracy_lab,
                              Plant_accuracy_decision,
                              Plant_accuracy_timing)

reason_plant_testing
## add this 12/12

reason_plant_testing <- reason_plant_testing %>%
  group_by(Resp_Group) %>%
  mutate(percent = 
           (freq = n / sum(n)))

head(reason_plant_testing)

#text is too long
reason_plant_testing <- mutate(
  reason_plant_testing,
  names_display = case_when(
    reason == "The cost of sampling" ~ "cost",
    reason == "The time required for sampling" ~ "time",
    reason == "The cost of lab analysis" ~ "cost of lab analysis",
    reason == "The difficulty in being able to represent the variability in a paddock" ~ "variability",
    reason == "The level of accuracy of lab analysis" ~ "accuracy",
    reason == "The ability to translate test results into a profitable decision" ~ "translate profitable decision",
    reason == "Not being able to get test results at the right time for decision making" ~ "get results at right time"
  )
)
...
```{r Q27.0 graph and table comments, echo=FALSE}
filter(reason_plant_testing, Resp_Group == "Agronomist") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
...
filter(reason_plant_testing, Resp_Group == "Grower") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
...
ggplot(reason_plant_testing, aes (x =  reorder(names_display, -percent), y = percent, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(.~ Resp_Group )+
  theme_classic()+
  labs(x= "",
       ...
       title = "Plant testing",
       subtitle = "",
       caption = "Q)Please indicate why you don't do more PLANT testing?")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
...
```{r Q27.0 graph comments, echo=FALSE}



#table
  Q27 <- filter(data, Q_27.8 !=  "NA") %>% select(Resp_Group, Q_27.8 )
  
  datatable(Q27, options = list(pageLength = 35, dom = 't'),
            colnames = c( "Comments" = "Q_27.8", 
                          "Respondent" = "Resp_Group")) 
...
* The use of plant testing on my farm increases my profitability(Grower Only Q)

```{r Q28 working, warning=FALSE, include=FALSE}
data$Q_28.1
data$Q_28.2
data$Q_28.3
data$Q_28.4
...
#group the Q21 data together
subsetQ28 <- select(data, Q_28.1, Q_28.2, Q_28.3, Q_28.4, Q_28.5, Resp_Group) 
#how many people ans the questions
data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_Q_28.1 = sum(!is.na(Q_28.1)))  #Agro = 54, Grower = 31
data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_Q_28.2 = sum(!is.na(Q_28.2)))  #Agro = 54, Grower = 31
data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_Q_28.3 = sum(!is.na(Q_28.3)))  #Agro = 54, Grower = 31
data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_Q_28.4 = sum(!is.na(Q_28.4)))  #Agro = 0, Grower = 23
...
subsetQ28.4_summary <- 
  filter(subsetQ28, Q_28.4 != "NA") %>% 
  group_by( Resp_Group) %>%
  count(Q_28.4) %>% 
  mutate(percent = 
           (freq = n / sum(n)),
         question = "my_profitability")

subsetQ28.1_summary



subsetQ28.1_summary <- ungroup(subsetQ28.1_summary)
subsetQ28.1_summary <- rename(subsetQ28.1_summary , "scale" = "Q_28.1")

subsetQ28.2_summary <- ungroup(subsetQ28.2_summary)
subsetQ28.2_summary <- rename(subsetQ28.2_summary , "scale" = "Q_28.2")

subsetQ28.3_summary <- ungroup(subsetQ28.3_summary)
subsetQ28.3_summary <- rename(subsetQ28.3_summary , "scale" = "Q_28.3")

subsetQ28.4_summary <- ungroup(subsetQ28.4_summary)
subsetQ28.4_summary <- rename (subsetQ28.4_summary , "scale" = "Q_28.4")

subsetQ28_summary <- rbind(subsetQ28.1_summary,
                           subsetQ28.2_summary,
                           subsetQ28.3_summary,
                           subsetQ28.4_summary)
subsetQ28_summary
...
```{r Q28 table and graph profitable, echo=FALSE, warning=FALSE}
#  more profitable table 1


filter(subsetQ28_summary,
       Resp_Group == "Agronomist" &
         question == "more profitable") %>%
  select(Resp_Group, scale, n, percent, question) %>%
  datatable(
    colnames = c(
      "Respondent" = "Resp_Group",
      "scale" = "scale",
...
filter(subsetQ28_summary, question == "more profitable" ) %>% 
  ggplot( aes (x =  reorder(scale, -percent), y = percent, 
               fill = Resp_Group))+
  geom_col() +
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(.~ Resp_Group )+
  ...
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "More profitable with more plant testing",
       subtitle = "",
       caption = "Q)My clients businesses would be more profitable if they did more plant testing than they do now")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
```

```{r Q28 table and graph uncertain, echo=FALSE, warning=FALSE}
#  more Uncertainty table 1
...
#  more Uncertainty graph

filter(subsetQ28_summary, question == "Uncertainty" ) %>% 
  ggplot( aes (x =  reorder(scale, -percent), y = percent, 
               fill = Resp_Group))+
  geom_col() +
  scale_fill_manual(values=c("grey70", "grey40"))+
  ...
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "Uncertainty about how the season will devalue plant testing",
       subtitle = "",
       caption = "Q)Uncertainty about how the season will turn out makes it hard to get value from plant testing results")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
...
```{r Q28 table and graph recommend1, echo=FALSE, warning=FALSE}
#  more Uncertainty table 1
...
#  more recommend graph

filter(subsetQ28_summary, question == "recommend" ) %>% 
  ggplot( aes (x =  reorder(scale, -percent), y = percent, 
               fill = Resp_Group))+
  geom_col() +
  scale_fill_manual(values=c("grey70", "grey40"))+
  ...
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "Recommend regular plant testing to others",
       subtitle = "",
       caption = "Q)My clients recommend the use of regular plant testing to other local farmers")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
...
```{r Q28 table and graph recommend, echo=FALSE, warning=FALSE}
#  more Uncertainty table 1
...
filter(subsetQ28_summary, question == "my_profitability" ) %>% 
  ggplot( aes (x =  reorder(scale, -percent), y = percent, 
               fill = Resp_Group))+
  geom_col() +
  scale_fill_manual(values=c("grey70", "grey40"))+
  ...
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "Plant testing increases my profitability",
       subtitle = "",
       caption = "Q)The use of plant testing on my farm increases my profitability")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
...
```{r Q28.0 graph comments, echo=FALSE}



#table
  Q28 <- filter(data, Q_28.5 !=  "NA") %>% select(Resp_Group, Q_28.5 )
  
  datatable(Q28, options = list(pageLength = 35, dom = 't'),
            colnames = c( "Comments" = "Q_28.5", 
                          "Respondent" = "Resp_Group")) 
...
```{r Q29 working, include=FALSE}
data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_29.1 = sum(!is.na(Q_29.1))) #agro =54 and grower = 30

Q29 <- select(data, Resp_Group, Q_29.1 , Q_29.2)
Q29
Q29 <-  filter (Q29,   Q_29.1 !=  "NA") %>%
  mutate(
    Q_29.1_recode = case_when(
      Q_29.1 ==   "0" ~  "< $2500",
      Q_29.1 == 	"$1 - $2,500"  ~  "< $2500",
      Q_29.1 == 	"$2,500 - $5,000"  ~  "> $2500",
      Q_29.1 == 	"$15,000 - $17,500"  ~  "> $2500",
      Q_29.1 == 	"$5,000 - $7,500"  ~  "> $2500",
      Q_29.1 == 	"$10,000 - $12,500"  ~  "> $2500",
      Q_29.1 == 	"$17,500 - $20,000"  ~  "> $2500",
      Q_29.1 == 	"$7,500 - $10,000"  ~  "> $2500",
      TRUE ~ "****"
    )
  )
...
```{r Q29 table and graph, echo=FALSE, warning=FALSE}
datatable(Q29_summary, options = list(pageLength = 35, dom = 't'),
          colnames = c( "spend" = "Q_29.1_recode", "Respondent" = "Resp_Group", "count" = "n")) %>% 
  formatPercentage('percent', 0)  



ggplot(Q29_summary, aes(Q_29.1_recode , percent, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(. ~ Resp_Group)+
  theme_classic()+
  labs(x= "Average spend each year",
       ...
       title = "Spend per year",
       subtitle = "",
       caption = "Q) On average, how much would your clients / you spend per year on plant testing (including sampling)?")+
...
```{r Q29.0 graph comments, echo=FALSE}



#table
  Q29_comments <- filter(data, Q_29.2 !=  "NA") %>% select(Resp_Group, Q_29.2 )
  
  datatable(Q29_comments, options = list(pageLength = 35, dom = 't'),
            colnames = c( "Comments" = "Q_29.2", 
                          "Respondent" = "Resp_Group")) 
...
```{r Q30 working, warning=FALSE, include=FALSE}
data$Q_30
unique(data$Q_30)
data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_30 = sum(!is.na(Q_30))) #ago #53 grower #28

Q30 <- select(data, Resp_Group, Q_30)
Q30
Q30_summary <- 
  filter(Q30, Q_30 != "NA") %>% 
  group_by( Resp_Group) %>%
...
```{r Q30 table and graph, echo=FALSE, warning=FALSE}
datatable(Q30_summary, options = list(pageLength = 35, dom = 't'),
          colnames = c( "compared to 5 years ago" = "Q_30", "Respondent" = "Resp_Group", "count" = "n")) %>% 
  formatPercentage('percent', 0)  



ggplot(Q30_summary, aes(Q_30 , percent, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(. ~ Resp_Group)+
  theme_classic()+
  labs(x= "",
       y = "Percent responded to question",
       fill = "",
       title = "Change in plant testing",
       subtitle = "",
       caption = "Q) Compared to five years' ago, has the amount of plant testing you do / recommend changed?")+
...
```{r Q31 working, warning=FALSE, include=FALSE}
data$Q_31
unique(data$Q_31)
data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_31 = sum(!is.na(Q_31))) #ago #53 grower #28

Q31 <- select(data, Resp_Group, Q_31)
Q31
Q31_summary <- 
  filter(Q31, Q_31 != "NA") %>% 
  group_by( Resp_Group) %>%
...
```{r Q31 table and graph, echo=FALSE, warning=FALSE}
datatable(Q31_summary, options = list(pageLength = 35, dom = 't'),
          colnames = c( "In 5 years" = "Q_31", "Respondent" = "Resp_Group", "count" = "n")) %>% 
  formatPercentage('percent', 0)  



ggplot(Q31_summary, aes(Q_31 , percent, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(. ~ Resp_Group)+
  theme_classic()+
  labs(x= "",
       y = "Percent responded to question",
       fill = "",
       title = "Future plant testing",
       subtitle = "",
       caption = "Q) In five years' time,how much plant sampling do you expect to be doing / recommending?")+
...
```{r Q32 text comments, echo=FALSE}



#table
  Q32_comments <- filter(data, Q_32 !=  "NA") %>% select(Resp_Group, Q_32 )
  
  datatable(Q32_comments, options = list(pageLength = 35, dom = 't'),
            colnames = c( "Comments" = "Q_32", 
                          "Respondent" = "Resp_Group")) 
...
```{r Q33 working, warning=FALSE, include=FALSE}
##function for to cal the % of respnondents This was defined above
# summary_stats_all_resp <- function(df, group_by, clm_in_df){
#   df <- filter( df, !! clm_in_df != "NA") %>%
#     group_by(!! group_by) %>%
...
soilN_cost <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_33.1))
soilN_time <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_33.2))
soilN_lab_cost <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_33.3))
soilN_variability <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_33.4))
soilN_accuracy_lab <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_33.5))
soilN_accuracy_decision <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_33.6))
soilN_accuracy_timing <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_33.7))

#join the reasons together

soilN_testing <- rbind(soilN_cost, 
                       soilN_time,
                       soilN_lab_cost,
                       soilN_variability,
                       soilN_accuracy_lab,
                       soilN_accuracy_decision,
                       soilN_accuracy_timing)

soilN_testing
## add this 12/12

soilN_testing <- soilN_testing %>%
  group_by(Resp_Group) %>%
  mutate(percent = 
           (freq = n / sum(n)))

head(soilN_testing$reason)

#text is too long
soilN_testing <- mutate(
  soilN_testing,
  names_display = case_when(
    reason == "The cost of soil sampling" ~ "cost",
    reason == "The time required for soil sampling" ~ "time",
...
```{r Q33 graphs and table, echo=FALSE, warning=FALSE}
filter(soilN_testing, Resp_Group == "Agronomist") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
...
filter(soilN_testing, Resp_Group == "Grower") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
...
ggplot(soilN_testing, aes (x =  reorder(names_display, -percent), y = percent, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(.~ Resp_Group )+
  theme_classic()+
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "Soil Nitrogen testing",
       subtitle = "",
       caption = "Q) Please indicate why you don't do SOIL Nitrogen testing")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
```
...
```{r Q33 text comments, echo=FALSE}



#table
  Q33_comments <- filter(data, Q_33.8 !=  "NA") %>% select(Resp_Group, Q_33.8 )
  
  datatable(Q33_comments, options = list(pageLength = 35, dom = 't'),
            colnames = c( "Comments" = "Q_33.8", 
                          "Respondent" = "Resp_Group")) 
...
```{r Q 34 working, warning=FALSE, include=FALSE}
soilP_cost <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_34.1))
soilP_time <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_34.2))
soilP_lab_cost <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_34.3))
soilP_variability <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_34.4))
soilP_accuracy_lab <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_34.5))
soilP_accuracy_decision <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_34.6))
soilP_accuracy_timing <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_34.7))

#join the reasons together

soilP_testing <- rbind(soilP_cost, 
                       soilP_time,
                       soilP_lab_cost,
                       soilP_variability,
                       soilP_accuracy_lab,
                       soilP_accuracy_decision,
                       soilP_accuracy_timing)

soilP_testing
## add this 12/12

soilP_testing <- soilP_testing %>%
  group_by(Resp_Group) %>%
  mutate(percent = 
           (freq = n / sum(n)))

head(soilP_testing$reason)

#text is too long
soilP_testing <- mutate(
  soilP_testing,
  names_display = case_when(
    reason == "The cost of soil sampling" ~ "cost",
    reason == "The time required for soil sampling" ~ "time",
...
```{r Q34 tables and graphs, echo=FALSE, warning=FALSE}
filter(soilP_testing, Resp_Group == "Agronomist") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
...
filter(soilP_testing, Resp_Group == "Grower") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
...
ggplot(soilP_testing, aes (x =  reorder(names_display, -percent), y = percent, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(.~ Resp_Group )+
  theme_classic()+
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "Soil Phosphorous testing",
       subtitle = "",
       caption = "Q) Please indicate why you don't do SOIL Phosphorous testing")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
...
```{r Q34 text comments, echo=FALSE}



#table
  Q34_comments <- filter(data, Q_34.8 !=  "NA") %>% select(Resp_Group, Q_34.8 )
  
  datatable(Q34_comments, options = list(pageLength = 35, dom = 't'),
            colnames = c( "Comments" = "Q_34.8", 
                          "Respondent" = "Resp_Group")) 
...
* My clients businesses would be more profitable if they did more soil testing than they do 
...
```{r Q35 working, warning=FALSE, include=FALSE}
data$Q_35.1
data$Q_35.2
...
#how many people ans the questions
data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_Q_35.1 = sum(!is.na(Q_35.1)))  #Agro = 3, Grower = 38
data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_Q_35.2 = sum(!is.na(Q_35.2)))  #Agro = 3, Grower = 38
...
subsetQ35.1_summary <- ungroup(subsetQ35.1_summary)
subsetQ35.1_summary <- rename(subsetQ35.1_summary , "scale" = "Q_35.1")

subsetQ35.2_summary <- ungroup(subsetQ35.2_summary)
subsetQ35.2_summary <- rename(subsetQ35.2_summary , "scale" = "Q_35.2")
...
```{r Q35 table and graphs profit, echo=FALSE, warning=FALSE}
filter(subsetQ35_summary,
       Resp_Group == "Agronomist" &
         question == "more profitable") %>%
  select(Resp_Group, scale, n, percent, question) %>%
  datatable(
...
filter(subsetQ35_summary, question == "more profitable" ) %>% 
  ggplot( aes (x =  reorder(scale, -percent), y = percent, 
               fill = Resp_Group))+
  geom_col() +
  scale_fill_manual(values=c("grey70", "grey40"))+
  ...
  labs(x= "",
       ...
       title = "More profitable with more soil testing",
       subtitle = "",
       caption = "Q) My farm business would be more profitable if I did more soil testing than I do now")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
...
```{r Q35 table and graphs Uncertainty, echo=FALSE, warning=FALSE}
filter(subsetQ35_summary,
       Resp_Group == "Agronomist" &
         question == "Uncertainty") %>%
  select(Resp_Group, scale, n, percent, question) %>%
...
filter(subsetQ35_summary, question == "Uncertainty" ) %>% 
  ggplot( aes (x =  reorder(scale, -percent), y = percent, 
               fill = Resp_Group))+
  geom_col() +
  scale_fill_manual(values=c("grey70", "grey40"))+
  ...
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "Uncertainty about how the season devalues soil testing",
       subtitle = "",
       caption = "Q) Uncertainty about how the season will turn out makes it hard to get value from soil testing results")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
...
```{r Q36 working, warning=FALSE, include=FALSE}
data$Q_36
data$Q_36.1

Plant_cost <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_36.1))
Plant_time <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_36.2))
Plant_lab_cost <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_36.3))
Plant_variability <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_36.4))
Plant_accuracy_lab <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_36.5))
Plant_accuracy_decision <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_36.6))
Plant_accuracy_timing <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_36.7))

#join the reasons together

Plant_testing <- rbind(Plant_cost, 
                       Plant_time,
                       Plant_lab_cost,
                       Plant_variability,
                       Plant_accuracy_lab,
...
Plant_testing <- Plant_testing %>%
  group_by(Resp_Group) %>%
  mutate(percent = 
           (freq = n / sum(n)))

unique(Plant_testing$reason)
...
```{r Q36 table and graphs, echo=FALSE, warning=FALSE}
filter(soilP_testing, Resp_Group == "Agronomist") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
...
```{r Q36 text comments, echo=FALSE}



#table
  Q36_comments1 <- filter(data, Q_36 !=  "NA") %>% select(Resp_Group, Q_36 )
  
  datatable(Q36_comments1, options = list(pageLength = 35, dom = 't'),
            caption = "Comments asked twice for the is question",
            
            colnames = c( "Comments" = "Q_36", 
                          "Respondent" = "Resp_Group")) 

Q36_comments2 <- filter(data, Q_36.8 !=  "NA") %>% select(Resp_Group, Q_36.8 )
  
  datatable(Q36_comments2, options = list(pageLength = 35, dom = 't'),
            caption = "Comments asked twice for the is question",
            colnames = c( "Comments" = "Q_36.8", 
                          "Respondent" = "Resp_Group")) 
```
...
```{r Q37 working, warning=FALSE, include=FALSE}
data$Q_37.1
data$Q_37.2


#group the Q37 data together
subsetQ37 <- select(data, Q_37.1, Q_37.2,  Resp_Group) 
#how many people ans the questions
data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_Q_37.1 = sum(!is.na(Q_37.1)))  #Agro = 3, Grower = 42
data %>% group_by(Resp_Group) %>% summarise(non_na_count_Q_Q_37.2 = sum(!is.na(Q_37.2)))  #Agro = 3, Grower = 38
...
subsetQ37.1_summary <- ungroup(subsetQ37.1_summary)
subsetQ37.1_summary <- rename(subsetQ37.1_summary , "scale" = "Q_37.1")

subsetQ37.2_summary <- ungroup(subsetQ37.2_summary)
subsetQ37.2_summary <- rename(subsetQ37.2_summary , "scale" = "Q_37.2")
...
```{r Q37 table and graph profit, echo=FALSE, warning=FALSE}
filter(subsetQ37_summary,
       Resp_Group == "Agronomist" &
         question == "more profitable") %>%
  select(Resp_Group, scale, n, percent, question) %>%
  datatable(
...
filter(subsetQ37_summary, question == "more profitable" ) %>% 
  ggplot( aes (x =  reorder(scale, -percent), y = percent, 
               fill = Resp_Group))+
  geom_col() +
  scale_fill_manual(values=c("grey70", "grey40"))+
  ...
  labs(x= "",
       ...
       title = "More profitable with more plant testing",
       subtitle = "",
       caption = "Q) My farm business would be more profitable if I did more plant testing than I do now")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
```
...
```{r Q37 table and graph Uncertainty, echo=FALSE, warning=FALSE}
filter(subsetQ37_summary,
       Resp_Group == "Agronomist" &
         question == "Uncertainty") %>%
  select(Resp_Group, scale, n, percent, question) %>%
...
filter(subsetQ37_summary, question == "Uncertainty" ) %>% 
  ggplot( aes (x =  reorder(scale, -percent), y = percent, 
               fill = Resp_Group))+
  geom_col() +
  scale_fill_manual(values=c("grey70", "grey40"))+
  ...
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "Uncertainty about how the season devalues plant testing",
       subtitle = "",
       caption = "Q) Uncertainty about how the season will turn out makes it hard to get value from plant testing results")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
...
* No comments in excel sheet

```{r Q37 text comments, echo=FALSE}



# #table
#   Q37_comments <- filter(data, Q_37.3 !=  "NA") %>% select(Resp_Group, Q_37.3 )
#   
#   datatable(Q37_comments, options = list(pageLength = 35, dom = 't'),
#             #caption = "Comments asked twice for the is question",
#             
#             colnames = c( "Comments" = "Q_37.3", 
#                           "Respondent" = "Resp_Group")) 
# 
...
```{r Q38 soil working, warning=FALSE, include=FALSE}
unique(data$Q_38)
unique(data$Q_38.1)
unique(data$Q_38.2)
unique(data$Q_38.3)
...
Sampling_cost_soil <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_38.1))
Analysis_cost_soil <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_38.2))
Sampling_time_soil <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_38.3))
Analysis_time_soil <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_38.4))
Understanding_soil <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_38.5)) #Understanding / interpreting results
Sampling_method_soil <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_38.6))


#join the reasons together

barriers_soil_test <- rbind(Sampling_cost_soil, 
                            Analysis_cost_soil,
                            Sampling_time_soil,
                            Analysis_time_soil,
                            Understanding_soil,
                            Sampling_method_soil)
unique(barriers_soil_test$reason)
## add this 12/12

barriers_soil_test <- barriers_soil_test %>%
  group_by(Resp_Group) %>%
  mutate(percent = 
           (freq = n / sum(n)))
...
#text is too long
barriers_soil_test <- mutate(
  barriers_soil_test,
  names_display = case_when(
    reason == "Sampling cost" ~ "Sampling cost",
    reason == "Analysis cost" ~ "Analysis cost",
    reason == "Sampling time" ~ "Sampling time",
    reason == "Analysis time" ~ "	Analysis time",
    reason == "Understanding / interpreting results" ~ "Understanding results	",
    reason == "Sampling method" ~ "Sampling method"))
```


```{r Q38 table and grap3 soil, echo=FALSE, warning=FALSE}
filter(barriers_soil_test, Resp_Group == "Agronomist") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
...
filter(barriers_soil_test, Resp_Group == "Grower") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
...
ggplot(barriers_soil_test, aes (x =  reorder(names_display, -percent), y = percent, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(.~ Resp_Group )+
  theme_classic()+
  labs(x= "",
       y = "Percentage of respondents to question",
       title = "Barriers to soil testing",
       subtitle = "",
       caption = "Q) What are the barriers to you undertaking soil testing")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
```
...
```{r Q39 plant working, include=FALSE}
unique(data$Q_39)
unique(data$Q_39.1)
unique(data$Q_39.2)
unique(data$Q_39.3)
...
Sampling_cost_plant <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_39.1))
Analysis_cost_plant <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_39.2))
Sampling_time_plant <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_39.3))
Analysis_time_plant <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_39.4))
Understanding_plant <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_39.5)) #Understanding / interpreting results
Sampling_method_plant <- summary_stats_all_resp(data, quo(Resp_Group), quo(Q_39.6))


#join the reasons together

barriers_plant_test <- rbind(Sampling_cost_plant, 
                            Analysis_cost_plant,
                            Sampling_time_plant,
                            Analysis_time_plant,
                            Understanding_plant,
                            Sampling_method_plant)
unique(barriers_plant_test$reason)
## add this 12/12

barriers_plant_test <- barriers_plant_test %>%
  group_by(Resp_Group) %>%
  mutate(percent = 
           (freq = n / sum(n)))
...
```{r Q39 plant table and graph, echo=FALSE}
filter(barriers_plant_test, Resp_Group == "Agronomist") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
...
filter(barriers_plant_test, Resp_Group == "Grower") %>% 
  select(Resp_Group , names_display, n , percent ) %>%
  datatable( 
    colnames = c("Respondent" = "Resp_Group",
                 "reason" = "names_display",
...
ggplot(barriers_plant_test, aes (x =  reorder(names_display, -percent), y = percent, fill = Resp_Group))+
  geom_col()+
  scale_fill_manual(values=c("grey70", "grey40"))+
  facet_wrap(.~ Resp_Group )+
  theme_classic()+
  labs(x= "",
       ...
       title = "",
       subtitle = "",
       caption = "Q) What are the barriers to you undertaking plant testing")+
  theme(axis.text.x=element_text(angle=90,hjust=1),
        plot.caption = element_text(size = 8), legend.position = "none") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 5L)) 
...
```{r Q40 text comments, echo=FALSE}



# #table
   Q40_comments1 <- filter(data, Q_40.1 !=  "NA") %>% select(Resp_Group, Q_40.1 )

  datatable(Q40_comments1, options = list(pageLength = 35, dom = 't'),
            caption = "Comments asked twice for the is question",

            colnames = c( "Comments" = "Q_40.1",
                          "Respondent" = "Resp_Group"))
  
     Q40_comments2 <- filter(data, Q_40.1 !=  "NA") %>% select(Resp_Group, Q_40.2 )
    Q40_comments2 <- Q40_comments2[c(3,8),c(1:2)]
  datatable(Q40_comments2, options = list(pageLength = 35, dom = 't'),
            caption = "Comments asked twice for the is question",

            colnames = c( "Comments" = "Q_40.2",
                          "Respondent" = "Resp_Group"))
...
```{r Q41 text comments, echo=FALSE}

# #table
   Q41_comments <- filter(data, Q_41 !=  "NA") %>% select(Resp_Group, Q_41 )

  datatable(Q41_comments, options = list(pageLength = 35, dom = 't'),
            caption = "Comments asked twice for the is question",

            colnames = c( "Comments" = "Q_41",
                          "Respondent" = "Resp_Group"))
...
```{r Q44 text comments, echo=FALSE}

# #table
   Q44_comments <- filter(data, Q_44 !=  "NA") %>% select(Resp_Group, Q_44 )
   #Q44_comments <- Q44_comments[-c(2,4,5),c(1:2)]
  datatable(Q44_comments, options = list(pageLength = 35, dom = 't'),
            caption = "Comments asked twice for the is question",

            colnames = c( "Comments" = "Q_44",
                          "Respondent" = "Resp_Group"))
...
```{r Q45 text comments, echo=FALSE}

# #table
   Q45_comments <- filter(data, Q_45 !=  "NA") %>% select(Resp_Group, Q_45 )
   #Q45_comments <- Q44_comments[-c(2,4,5),c(1:2)]
  datatable(Q45_comments, options = list(pageLength = 35, dom = 't'),
            caption = "Comments asked twice for the is question",

            colnames = c( "Comments" = "Q_45",
                          "Respondent" = "Resp_Group"))
